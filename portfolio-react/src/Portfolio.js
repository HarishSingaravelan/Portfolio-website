...
// Define static SVG icons as React components
const SvgIcons = {
  Linkedin: () => (
  ...
  Github: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77a5.07 5.07 0 0 0-.07-3.62s-2.18.7-4.57 2.32a12.82 12.82 0 0 0-6.22 0c-2.39-1.62-4.57-2.32-4.57-2.32A5.07 5.07 0 0 0 2 4.77a5.44 5.44 0 0 0 1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
    </svg>
  ),
  Mail: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <rect width="20" height="16" x="2" y="4" rx="2" />
      <path d="m22 7l-10 7l-10-7" />
    </svg>
  ),
  Phone: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2.02a19.79 19.79 0 0 1-8.63-3.07a19.5 19.5 0 0 1-6-6a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72a12.84 12.84 0 0 0 .7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45a12.84 12.84 0 0 0 2.81.7a2 2 0 0 1 1.72 2v3" />
    </svg>
  ),
  Link: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.54-7.54l-3 3a5 5 0 0 0 7.54 7.54z" />
      <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.54 7.54l3-3a5 5 0 0 0-7.54-7.54z" />
    </svg>
  ),
};

const Project = ({ title, img, tech, description, link, linkText, borderColor, delay }) => {
  const IconComponent = linkText === 'Project Link' ? SvgIcons.Link : SvgIcons.Github;
  return (
    <div
      className={`bg-slate-800 p-6 rounded-2xl shadow-xl border border-slate-700 hover:border-${borderColor}-400 hover:scale-105 transition-all duration-300 card animate-on-scroll`}
    ...
    >
      ...
      <p className="text-sm font-light text-slate-400 mb-4">{tech}</p>
...
const ProjectSection = ({ projects, id, active }) => {
  // Use a unique key to force a re-render and re-run animations
  return (
    <div key={id} id={id} className={`project-section space-y-12 ${!active && 'hidden'}`}>
...
const Portfolio = () => {
  ...
  const activeClass = (tab) =>
    `project-btn px-6 py-2 rounded-full font-semibold transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 focus:ring-offset-slate-900 ${
      activeTab === tab
        ? 'active-btn text-white bg-slate-700'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="text-center md:text-left mb-12 flex flex-col items-center md:flex-row md:justify-between">
        <div>
          ...
          <p className="text-xl md:text-2xl font-medium text-slate-400 mb-6 section-title" style={{ animationDelay: '0.2s' }}>Data Scientist & Full Stack Developer</p>
          <div className="flex flex-col md:flex-row items-center md:justify-start space-y-3 md:space-y-0 md:space-x-8 text-slate-400 section-title" style={{ animationDelay: '0.4s' }}>
            ...
            <a href="mailto:harishsingaravelan990@gmail.com" className="hover:text-cyan-500 transition-colors duration-300 flex items-center space-x-2">
              <SvgIcons.Mail />
        ...
        <div className="mt-8 md:mt-0 md:ml-12 card">
          <img src="https://placehold.co/150x150/111827/4b5563?text=Profile" alt="Harish Singaravelan Profile" className="w-40 h-40 rounded-full border-4 border-slate-700 shadow-lg" />
        </div>
      </header>

      <section id="about" className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-6 border-b-2 border-sky-500 pb-2 section-title">About Me</h2>
        <div className="bg-slate-800 p-8 rounded-2xl shadow-xl animate-on-scroll">
          <p id="about-me-short" className="text-lg text-slate-300">
          ...
          <a href="#!" onClick={(e) => { e.preventDefault(); setShowFullAbout(!showFullAbout); }} className="text-sm font-semibold text-sky-400 hover:text-sky-300 mt-4 inline-block">
      ...
      <section id="skills" className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-6 border-b-2 border-sky-500 pb-2 section-title">Technical Skills</h2>
        <div className="bg-slate-800 p-8 rounded-2xl shadow-xl animate-on-scroll">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold text-sky-300 mb-2">Languages</h3>
            ...
            <div className="card" style={{ animationDelay: '0.2s' }}>
              <h3 className="text-xl font-semibold text-sky-300 mb-2">Web & Cloud</h3>
              <ul className="list-disc list-inside space-y-1 text-slate-300">
            ...
            <div className="card" style={{ animationDelay: '0.3s' }}>
              <h3 className="text-xl font-semibold text-sky-300 mb-2">Frameworks & Tools</h3>
              <ul className="list-disc list-inside space-y-1 text-slate-300">
            ...
            <div className="card" style={{ animationDelay: '0.4s' }}>
              <h3 className="text-xl font-semibold text-sky-300 mb-2">Data & Analytics</h3>
              <ul className="list-disc list-inside space-y-1 text-slate-300">
            ...
            <div className="card" style={{ animationDelay: '0.5s' }}>
              <h3 className="text-xl font-semibold text-sky-300 mb-2">Operating Systems</h3>
      ...
      <section id="projects" className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-6 border-b-2 border-sky-500 pb-2 section-title">Projects</h2>
      ...
      <section id="experience" className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-6 border-b-2 border-sky-500 pb-2 section-title">Experience</h2>
        <div className="bg-slate-800 p-8 rounded-2xl shadow-xl animate-on-scroll">
          <div className="flex flex-col md:flex-row justify-between mb-4">
            <h3 className="text-2xl font-semibold text-white">Full Stack Intern at Hyundai Motors</h3>
            <span className="text-lg text-slate-400">Feb 2023 | Chennai, India</span>
          </div>
      ...
      <section id="education" className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-6 border-b-2 border-sky-500 pb-2 section-title">Education</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-on-scroll">
          <div className="bg-slate-800 p-8 rounded-2xl shadow-xl card">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-2xl font-semibold text-white">Rochester Institute of Technology</h3>
              <span className="text-lg text-slate-400">2024-2026</span>
            </div>
            <p className="text-lg text-slate-300">M.S., Data Science</p>
            <p className="text-sm text-slate-400 mb-2">GPA: 3.94/4.0</p>
            <p className="text-slate-300 font-medium">Relevant Coursework:</p>
          ...
          <div className="bg-slate-800 p-8 rounded-2xl shadow-xl card" style={{ animationDelay: '0.2s' }}>
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-2xl font-semibold text-white">Anna University</h3>
              <span className="text-lg text-slate-400">2020-2024</span>
            </div>
            <p className="text-lg text-slate-300">B.E., Computer Science and Engineering</p>
            <p className="text-sm text-slate-400 mb-2">GPA: 8.5/10</p>
            <p className="text-slate-300 font-medium">Relevant Coursework:</p>
            <ul className="list-disc list-inside text-sm text-slate-400">
      ...
      <section id="achievements" className="mb-16">
        <h2 className="text-4xl font-bold text-white mb-6 border-b-2 border-sky-500 pb-2 section-title">Achievements</h2>
        <div className="bg-slate-800 p-8 rounded-2xl shadow-xl animate-on-scroll">
